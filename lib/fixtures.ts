...
function mk(partial: Partial<Transfer> & Pick<Transfer, "external_id" | "player_name" | "type">): Transfer {
  ...
  return {
    ...
    market_value_label: null,
    market_value_fetched_at: null,
...
export const PREVIEW_CASES: { title: string; note: string; transfer: Transfer }[] = [
  {
    ...
    transfer: mk({
      ...
      to_country_code: "fr",
      to_country_name: "France",
      to_competition: "Ligue 1",
      transfer_fee: "45 M€",
      // Un prix convenu ET une estimation : le prix doit gagner, c'est le seul
      // des deux qui soit un fait.
      market_value_eur: 40_000_000,
      market_value_label: "40 M€",
  ...
  },
  {
    ...
    transfer: mk({
      ...
      to_country_code: "gb-eng",
      to_country_name: "Angleterre",
      to_competition: "Premier League",
      transfer_fee: "32 M€",
  ...
  },
  {
    ...
    transfer: mk({
      ...
      to_country_code: "it",
      to_country_name: "Italie",
      to_competition: "Serie A",
      transfer_fee: "—",
      status_badge: "Jusqu'en 2029",
    }),
  },
  {
    title: "Rumeur tiède, valeur estimée",
    note: "Sous 70 : l'accent retombe en gris. Sans prix convenu, la carte montre la valeur de marché — et le dit.",
    transfer: mk({
      ...
      to_country_name: "Angleterre",
      to_competition: "Premier League",
      market_value_eur: 37_000_000,
      market_value_label: "37 M€",
  ...
  {
    title: "Pays hors table de correspondance",
    note: "Championnat exotique : la puce garde son nom et perd seulement son drapeau. La carte doit rester juste.",
    transfer: mk({
      external_id: "preview:unmapped",
      player_name: "Jón Sigurðsson",
      type: "RUMOUR",
      from_club_name: "Valur",
      to_club_name: "Víkingur",
      to_country_code: null,
      to_country_name: "Faroe Islands",
      to_competition: "Betri deildin",
      market_value_eur: 250_000,
      market_value_label: "250 k€",
      probability_score: 44,
      status_badge: "Discussions en cours",
    }),
  },
  {
